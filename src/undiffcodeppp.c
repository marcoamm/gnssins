...
//#define NX1          (4+3)       /* # of estimated parameters */
#define NX          (3+1+1)      /* # of estimated parameters for undifferenced */
                     ...
                     int iter, const prcopt_t *opt, double *var)
{
    ...
    double PC,P1,P2,P1_P2,P1_C1,P2_C2,gamma, meas[2];
    int i=0,j=1,sys;
...
static int rescode(int iter, const obsd_t *obs, int n, const double *rs,
                   ...
                   double *resp, int *ns)
{
    double r,dion,dtrp,vmeas,vion,vtrp,rr[3],pos[3],dtr,e[3],P[2],lam_L1;
    ...
    for (i=*ns=0;i<n&&i<MAXOBS;i++) {
        ...
        v[nv]=P[0]-(r+dtr-CLIGHT*dts[i*2]+dion+dtrp);
        v[nv+1]=P[1]-(r+dtr-CLIGHT*dts[i*2]+dion+dtrp);
	//printf("P: %lf and r: %lf, Correction: %lf, Residuals: %lf\n",P,r,dtr-CLIGHT*dts[i*2]+dion+dtrp,v[nv]);
                  ...
                  double *resp, char *msg)
{
    ...
    x=mat(5+n,1); dx=mat(5+n,1); Q=mat(5+n,5+n);
